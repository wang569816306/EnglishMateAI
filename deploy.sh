...
# 设置权限
chown -R www-data:www-data static/ 2>/dev/null || true

echo -e "${GREEN}✅ 前端整合完成${NC}"
echo ""

###############################################################################
# 步骤 5: 配置后端环境
###############################################################################
echo -e "${GREEN}[5/7] 配置后端环境...${NC}"
...
###############################################################################
# 步骤 6: 安装 Python 依赖并初始化
###############################################################################
echo -e "${GREEN}[6/7] 安装 Python 依赖并初始化数据库...${NC}"
